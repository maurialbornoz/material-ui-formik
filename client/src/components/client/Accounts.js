    ...
    <Box sx={{ width: '100%', py: 8 }}>
        ...
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
            ...
            <TableRow>
                ...
                <TableCell align="right">Do a Transfer</TableCell>
            </TableRow>
            </TableHead>
            <TableBody>
            {rows.map((row) => (
                ...
                >
                  ...
                  <TableCell align="right">
                    <IconButton onClick={() => navigate('/my_transactions', { state: { accountId : row._id } })}>
                      <CurrencyExchangeIcon />
                    </IconButton>
                  </TableCell>
                  <TableCell align="right"> 
                    <IconButton onClick={() => navigate('/transfer', { state: { alias : row.alias } })}>
                      <PaymentsIcon/> 
                    </IconButton> 
                  </TableCell>
